...
public class SDALinkRewriter implements LinkRewriter {

    private String base = null;

    public SDALinkRewriter(String landingPageBase) {
    ...
    public String rewriteOREMapLink(String sourceURL, String ro_id) {
        return base + encode(ro_id) + "/oremap.jsonld.txt";
    }

    public String rewriteAggregationLink(String sourceURL, String ro_id) {
        return base + encode(ro_id) + "/oremap.jsonld.txt#aggregation";
    }
